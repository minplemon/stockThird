...
def uu_get_price():
    ...
    """
    return get_price('000001.XSHE', start_date='2019-01-19', end_date='2019-06-19', frequency='daily',
...
def uu_get_ticks():
    ...
    """
    return get_ticks("000001.XSHE",start_dt=None, end_dt="2018-07-02", count=10)
