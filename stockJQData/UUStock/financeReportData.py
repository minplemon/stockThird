...
def uu_query_STK_INCOME_STATEMENT():
    ...
    q = query(finance.STK_INCOME_STATEMENT.company_name,
        ...
        finance.STK_INCOME_STATEMENT.code == '600519.XSHG', finance.STK_INCOME_STATEMENT.pub_date >= '2015-01-01',
...
def uu_query_STK_CASHFLOW_STATEMENT():
    ...
    q = query(finance.STK_CASHFLOW_STATEMENT.company_name,
        ...
        finance.STK_CASHFLOW_STATEMENT.code == '600519.XSHG', finance.STK_CASHFLOW_STATEMENT.pub_date >= '2015-01-01',
...
def uu_query_STK_BALANCE_SHEET():
    ...
    q = query(finance.STK_BALANCE_SHEET.company_name,
              ...
              finance.STK_BALANCE_SHEET.total_liability
                       ...
                       finance.STK_BALANCE_SHEET.pub_date >= '2015-01-01',
